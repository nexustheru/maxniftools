...
extern ClassDesc2* GetmaxniftoolsDesc();
extern ClassDesc2* GetmaxtoolsimporterDesc();
extern ClassDesc2* GetmaxniftoolsexporterDesc();
...
{
	switch(i) {
		case 0: return GetmaxniftoolsDesc();
		case 1: return GetmaxtoolsimporterDesc();
